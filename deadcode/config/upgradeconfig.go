...
import (
	"github.com/palantir/godel-okgo-asset-deadcode/deadcode/config/internal/legacy"
	v0 "github.com/palantir/godel-okgo-asset-deadcode/deadcode/config/internal/v0"
